...
# Initialize variables to track errors during training and testing
...
# Plot the training and testing errors over the epochs
plot(training_errors, type = "l", col = "blue", xlab = "Epoch #", 
     ylab = "Errors", ylim = c(0, max(training_errors, testing_errors)))
